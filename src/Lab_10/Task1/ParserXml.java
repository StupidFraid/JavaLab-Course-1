...
import Lab_10.Task1.model.Book;
...
//    private static final String TAG_NAME_MAIN = "library";
    ...
    private Document buildDocument() throws Exception{
        File file = new File("Programming_Git/src/Lab_10/example_files/exampleAddNewBook.xml");
    ...
    public void addNewBookXml() {
        ...
        try {
            ...
            StreamResult result = new StreamResult("Programming_Git/src/Lab_10/example_files/exampleAddNewBook.xml");
